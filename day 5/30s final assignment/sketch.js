...
let pic7, pic8, pic9, pic10, pic11, pic12, pic13, pic14, pic15, pic16, pic17, pic18, pic19, pic20, pic21, pic22,pic23,pic24,pic25,pic26,pic27;
//
let posX1 = 0
let posY1 = 0
let posX2 = 0
...
function preload() {
  ...
  breath2 = loadSound("sounds/breath2.mp3");
  damage = loadSound("sounds/damage.mp3");
  flashback = loadSound("sounds/flashback.mp3");
  footsound = loadSound("sounds/footsound.mp3");
  gasp1 = loadSound("sounds/gasp1.mp3");
  gasp2 = loadSound("sounds/gasp2.mp3");
  impact = loadSound("sounds/impact.mp3");
  slash1 = loadSound("sounds/slash1.mp3");
  slash2 = loadSound("sounds/slash2.mp3");
  slash3 = loadSound("sounds/slash3.mp3");
  slash4 = loadSound("sounds/slash4.mp3");
  swoosh = loadSound("sounds/swoosh.mp3");
  swordimpact = loadSound("sounds/swordimpact.mp3");
